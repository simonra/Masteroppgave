...
In our structured literature review we came across several methods of solving routing problems. Clearly, the most desirable outcome would be a solution that can be known to be optimal.

% Euler -> Mei-Ko Kwan -> Spider. (Nevne at matten i spider er grusom?)
% Tabu -> SA -> Tabu + SA
% EA -> GA -> MA 
