...
\begin{algorithmic}[1]
\algdef{SE}[DOWHILE]{Do}{DoWhile}{\algorithmicdo}[1]{\algorithmicwhile\ #1}%http://tex.stackexchange.com/questions/115709/do-while-loop-in-pseudo-code
...
\Procedure{Split}{Genotype,Graph,Distances}
	...
	\For{$i \leftarrow 1$ \textbf{to} $numberOfElements + 1$}
		...
		\DoWhile{$(j < numberOfElements + 1)\wedge(load < vehicle\_capacity)$}
	\EndFor
