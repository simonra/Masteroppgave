...
% \begin{figure}[thbp]
	...
	% \label{fig:ctmasd}
% \end{figure}
\includepdf[landscape=true,pages={-},pagecommand={\pagestyle{fancy}},height=0.945\textwidth]{figures/Routes/DetailedMaps-atlases/2015-06-23-final_detailed_atlas_for_KV_B_midtbyen.pdf}
% \end{landscape}
...
% \begin{landscape}
% \begin{figure}[thbp]
\includepdf[landscape=true,pages={-},pagecommand={\pagestyle{fancy}},height=0.945\textwidth]{figures/Routes/DetailedMaps-atlases/2015-06-23-final_detailed_atlas_for_KV_H_midtbyen.pdf}
% 	\caption{Mutation - Average Standard Deviation}
% 	\label{fig:ctmasd}
% \end{figure}
% \end{landscape}
